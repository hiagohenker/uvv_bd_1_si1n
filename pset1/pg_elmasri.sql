-- CRIANDO USUÁRIO COM AS DEVIDAS PERMISSÕES
CREATE ROLE hiago WITH
  LOGIN
  SUPERUSER
  INHERIT
  CREATEDB
...
-- CRIANDO ESQUEMA ELMASRI COM A AUTORIZAÇÃO DO MEU USUÁRIO
...
-- CRIANDO UMA TABELA DE FUNCIONARIO
...
-- COMENTARIOS DA TABELA CRIADA E DE CADA COLUNA 
...
-- CRIANDO UMA TABELA DE DEPENDENTE
...
-- CRIANDO UMA TABELA DO DEPARTAMENTO
...
-- COMENTÁRIOS DA TABELA CRIADA E DE CADA COLUNA
...
-- TRANSFORMANDO O NOME DO DEPARTAMENTO EM UMA CHAVE ÚNICA (AK)

CREATE UNIQUE INDEX departamento_idx
 ON elmasri.departamento
 ( nome_departamento );

-- CRIAR TABELA DO PROJETO
...
-- COMENTÁRIOS DA TABELA CRIADA E DE CADA COLUNA SUA
...
-- TRANSFORMANDO O NOME DO PROJETO EM UMA CHAVE ÚNICA (AK)

CREATE UNIQUE INDEX projeto_idx
 ON elmasri.projeto
 ( nome_projeto );

-- CRIAR TABELA DE TRABALHA_EM
...
-- CRIAR TABELA DAS LOCALIZAÇÕES DO DEPARTAMENTO
...
-- COMENTÁRIOS DA TABELA E DE CADA COLUNA
...
-- RELACIONAMENTO ENTRE AS TABELAS PARA ADICIONAR UMA FOREIGN KEY (FK)
